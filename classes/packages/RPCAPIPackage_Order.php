 ...
 * @version     0.7 изменения от 05.05.2011
...
class RPCAPIPackage_Order extends Package
{
     ...
     * @param string $sTitle Название продукта
     * @return void
     */
    ...
    public function vUpdateProduct($iProductId, $iCnt)
    {
        ...
        if (!is_null($iKeyUpdate)) {
            ...
            $this->aProducts[$iKeyUpdate]['sum'] = $this->aProducts[$iKeyUpdate]['quantity'] * $this->aProducts[$iKeyUpdate]['price'];
        }
    }
